package com.jantiojo.utils

import com.jantiojo.xpaysdk.XpayLEDColor
import com.jantiojo.xpaysdk.XpayLEDState
import com.newland.nsdk.core.api.common.led.LEDColor
import com.newland.nsdk.core.api.common.led.LEDState

internal fun List<XpayLEDColor>.toArrayLEDColor(): Array<LEDColor> {
    return this.map {
...
internal fun XpayLEDState.toLEDState() = when (this) {
